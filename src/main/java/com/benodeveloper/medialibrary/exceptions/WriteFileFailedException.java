...
public class WriteFileFailedException extends FileOperationException {
    /**
     ...
     * @since 1.6
     */
    public WriteFileFailedException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.6
     */
    public WriteFileFailedException(Throwable cause) {
        super(cause);
    }
}
